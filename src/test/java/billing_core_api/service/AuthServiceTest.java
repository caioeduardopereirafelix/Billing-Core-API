...
class AuthServiceTest {
    ...
    @Test
    void shouldRegisterUserWithDefaultRoleHashedPasswordAndAuditDates() {
        ...
        verify(userValidator).validateEmail("caio@email.com");
        verify(repository).save(any(User.class));
    }

    @Test
    void shouldRejectDuplicatedEmailBeforeTouchingRolesOrPersistence() {
        doThrow(new EmailAlreadyExistException("Email already exists"))
                .when(userValidator).validateEmail(createUserDTO.email());
    ...
    void shouldFailWhenDefaultRoleIsMissing() {
        ...
        assertThrows(IllegalStateException.class, () -> service.register(createUserDTO));
